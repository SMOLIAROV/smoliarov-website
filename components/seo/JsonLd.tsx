        ...
        review: [
          {
            ...
            reviewBody:
              "Уехал в отпуск и ни разу не переживал за брони. Календарь сам всё отслеживал, клиенты получали уведомления, двойных накладок не было. Наконец-то выдохнул, огромное спасибо команде!",
          },
          {
            "@type": "Review",
            author: {
            ...
            reviewBody:
              "Заказы перестали теряться, всё летит в систему автоматически. Менеджеры больше не сидят в Excel, а занимаются клиентами. Скорость обработки выросла в разы — очень довольны.",
          },
          {
            "@type": "Review",
            author: {
            ...
            reviewBody:
              "Согласование с клиентами перестало быть головной болью. Всё в одной системе, уведомления приходят автоматически, документы всегда под рукой. Сократили время на 60%, клиенты счастливы.",
          },
        ],
      },
    ],
